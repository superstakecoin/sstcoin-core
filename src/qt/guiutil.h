...
/** Utility functions used by the SuperStakeCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render superstakecoin addresses in monospace font
...
// Parse "sstcoin:" URI into recipient object, return true on successful parsing
