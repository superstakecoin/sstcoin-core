...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SuperStakeCoin Core"),
     ...
     * override -datadir in the sstcoin.conf file in the default data directory
     * (to be consistent with sstcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
