                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SuperStakeCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a superstakecoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sstcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SuperStakeCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about SuperStakeCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SuperStakeCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your superstakecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified superstakecoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a sstcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SuperStakeCoin Core help message to get a list with possible SuperStakeCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SuperStakeCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SuperStakeCoin network", "", count));
}
...
{
    QString strTitle = tr("SuperStakeCoin Core"); // default title
    ...
    // Append title to "SuperStakeCoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
