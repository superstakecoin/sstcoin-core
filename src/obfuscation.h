...
{
public:
    /// Is the inputs associated with this public key? (and there is 1500 SSTC - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of superstakecoins.
