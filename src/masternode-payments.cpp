...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txNew, int64_t nFees, bool fProofOfStake)
{
    ...
    CAmount advisorsFee1 = GetAdvisorsFee1(blockValue);
    CAmount advisorsFee2 = GetAdvisorsFee2(blockValue);
    ...
    if (hasPayment) {
        if (fProofOfStake) {
	        ...
	        // advisors value + fee
            txNew.vout[i + 1].nValue = advisorsFee1;
            txNew.vout[i + 1].scriptPubKey = GetAdvisorsFeeScript1();

            txNew.vout[i + 2].nValue = advisorsFee2;
            txNew.vout[i + 2].scriptPubKey = GetAdvisorsFeeScript2();
            ...
            if (i == 3) {
                ...
                txNew.vout[i - 1].nValue -= advisorsFee1;
                txNew.vout[i - 1].nValue -= advisorsFee2;
            } else {
