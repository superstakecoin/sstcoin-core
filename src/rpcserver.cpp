...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SuperStakeCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SuperStakeCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SuperStakeCoin features */
        {"sstcoin", "masternode", &masternode, true, true, false},
        {"sstcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"sstcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sstcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sstcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sstcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"sstcoin", "startmasternode", &startmasternode, true, true, false},
        {"sstcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sstcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sstcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sstcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sstcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sstcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sstcoin", "mnsync", &mnsync, true, true, false},
        {"sstcoin", "spork", &spork, true, true, false},
        {"sstcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"sstcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use sstcoind, or the -server option to sstcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> sstcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12021/\n";
}
