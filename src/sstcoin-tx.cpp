...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SuperStakeCoin Core sstcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sstcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded superstakecoin transaction") + "\n" +
                               "  sstcoin-tx [options] -create [commands]   " + _("Create hex-encoded superstakecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded superstakecoin transaction
