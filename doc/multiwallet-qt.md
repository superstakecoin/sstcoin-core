...
In order to support loading of multiple wallets in sstcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sstcoin.cpp.

Finally, two new headers and source files will have to be added to sstcoin-qt.pro.
...
Changes to sstcoin.cpp
----------------------
sstcoin.cpp is the entry point into sstcoin-qt, and as such, will require some minor modifications to provide hooks for
