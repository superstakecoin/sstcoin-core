...
RESOURCES += src/qt/sstcoin.qrc src/qt/sstcoin_locale.qrc

TRANSLATIONS += src/qt/locale/sstcoin_bg.ts \
                src/qt/locale/sstcoin_de.ts \
                src/qt/locale/sstcoin_en.ts \
                src/qt/locale/sstcoin_es.ts \
                src/qt/locale/sstcoin_fi.ts \
                src/qt/locale/sstcoin_fr.ts \
                src/qt/locale/sstcoin_it.ts \
                src/qt/locale/sstcoin_ja.ts \
                src/qt/locale/sstcoin_pl.ts \
                src/qt/locale/sstcoin_pt.ts \
                src/qt/locale/sstcoin_ru.ts \
                src/qt/locale/sstcoin_sk.ts \
                src/qt/locale/sstcoin_sv.ts \
                src/qt/locale/sstcoin_vi.ts \
                src/qt/locale/sstcoin_zh_CN.ts \
                src/qt/locale/sstcoin_zh_TW.ts
