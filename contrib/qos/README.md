...
This means one can have an always-on sstcoind instance running, and another local sstcoind/sstcoin-qt instance which connects to this node and receives blocks from it.
