Contributing to SuperStakeCoin Core
============================

The SuperStakeCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SuperStakeCoin Core project, and is not to be
confused with overall SuperStakeCoin Network Protocol consensus changes.

Whether a pull request is merged into SuperStakeCoin Core rests with the project merge
...
Patches that change SuperStakeCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the SuperStakeCoin consensus, it must have been
...
The project leader is the release manager for each SuperStakeCoin Core release.
